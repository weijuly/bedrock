...
class PocketArticleManager(models.Manager):
    # TODO: should the following methods just be @classmethod's in the model below?
...
class PocketArticle(models.Model):
    ...
    # TODO: is this necessary? title's may have unicode characters, but i don't *think* will ever have markup
    @property
